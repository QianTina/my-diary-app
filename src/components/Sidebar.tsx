...
import { Home, PenLine, Archive, BarChart3, Settings, Sparkles, Search, Calendar, TestTube2, CheckSquare, BookOpen } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { path: '/notebooks', icon: BookOpen, label: '日记本', enLabel: 'Notebooks' },
    ...
    { path: '/notebook-test', icon: TestTube2, label: '📖 测试', enLabel: 'Notebook Test' },
